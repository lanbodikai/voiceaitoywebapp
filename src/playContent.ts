...
export const playDestinations: PlayDestination[] = [
  {
    id: 'boat', emoji: '⛵', zh: '云朵小船', en: 'Cloud Boat', cue: 'imagine_boat_start',
    openingZh: '我们坐上云朵小船啦！你想带谁一起出发？', openingEn: 'We are sailing in a cloud boat! Who should come with us?',
  ...
  {
    id: 'farm', emoji: '🌱', zh: '会唱歌的农场', en: 'Singing Farm', cue: 'imagine_farm_start',
    openingZh: '欢迎来到会唱歌的农场！你最想先见哪只动物？', openingEn: 'Welcome to the singing farm! Which animal should we meet first?',
  ...
  {
    id: 'restaurant', emoji: '🍜', zh: '魔法餐厅', en: 'Magic Restaurant', cue: 'imagine_restaurant_start',
    openingZh: '魔法餐厅开门啦！今天你想做什么好吃的？', openingEn: 'The magic restaurant is open! What should we cook today?',
